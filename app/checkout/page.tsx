        ...
        <div className="lg:col-span-2">
          <form onSubmit={handleSubmit} className="bg-white border border-gray-200 rounded p-6">
                  ...
                  >
                    {countries.map((country) => (
                      <option key={country.alpha2} value={country.name}>
                        {country.flag ? (
                          <span>
                            <img src={country.flag} alt={country.name + ' flag'} style={{ width: 20, height: 14, marginRight: 4, display: 'inline-block', verticalAlign: 'middle' }} />
                          </span>
                        ) : null}
                        {country.name}
                      </option>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600 mb-2">Or order via <strong>Whatsapp | Number | 254791792027</strong></p>
              <button
                type="button"
              ...
              >
                ...
                Send via Whatsapp | Number | 254791792027
              </button>
            </div>
